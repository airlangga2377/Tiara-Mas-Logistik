        ...
        <div class="row justify-content-center align-items-start">
            ...
            <div class="col-8 shadow-sm p-3" id="tableIdParent"> 
                <table id="tableId" class="display">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $pengiriman; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                            
                            <tr>
                                <td>
                                    <?php echo e($barang->nama_pengirim); ?>

                                </td>
                                <td> 
                                    <?php echo e($barang->nama_penerima); ?>

                                </td>
                                <td>
                                    <?php echo e($barang->harga_barang); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Kargo Website\resources\views/page/admin/bus/CargoBarang.blade.php ENDPATH**/ ?>