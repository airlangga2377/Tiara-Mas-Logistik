...
<div class="container">  
    ...
    <div class="row justify-content-between d-flex g-3">
        <label class="text-wrap g-5" id="pengiriman"><h2>KATEGORI BARANG</h2></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Kargo Website\resources\views/page/admin/Bus/KategoriBarangBus.blade.php ENDPATH**/ ?>