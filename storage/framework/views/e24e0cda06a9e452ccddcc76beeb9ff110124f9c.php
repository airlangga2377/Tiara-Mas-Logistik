                ...
                <table id="tableId" class="display table table-hover table-responsive">
                    ...
                    <?php for($i = 0; $i < 7; $i++): ?>
                        <tr>
                            ...
                            <?php if(old() != null): ?> 
                                <td>
                                    <input type="text" class="form-control fs-6" aria-label="Pilih Barang" id="jenisBarang" name="jenisBarang[]" value="<?php echo old('jenisBarang')[$i]; ?>" aria-describedby="jenisBarangText" placeholder="isi jenis barang"/>
                                </td>
                                <td>
                                    <input type="number" class="form-control fs-6" aria-label="Jumlah Barang" id="jumlahBarang" name="jumlahBarang[]" value="<?php echo old('jumlahBarang')[$i]; ?>" aria-describedby="jumlahBarangText" placeholder="isi jumlah barang">
                                </td>
                                <td>
                                    <input type="text" class="form-control fs-6" aria-label="keterangan" id="keterangan" name="keterangan[]" value="<?php echo old('keterangan')[$i]; ?>" aria-describedby="keteranganText" placeholder="isi keterangan">
                                </td>
                                <td>
                                    <input type="text" class="form-control fs-6" aria-label="biaya" id="biaya" name="biaya[]" value="<?php echo old('biaya')[$i]; ?>" aria-describedby="biayaText" placeholder="isi biaya">
                                </td>

                                
                                <td>
                                    <input type="text" class="form-control fs-6" name="kubikasiPanjang[]" value="<?php echo old('kubikasiPanjang')[$i]; ?>" id="kubikasiPanjang" aria-describedby="kubikasiPanjangText" placeholder="isi panjang">
                                </td> 
                                <td>
                                    <input type="text" class="form-control fs-6" name="kubikasiLebar[]" value="<?php echo old('kubikasiLebar')[$i]; ?>" id="kubikasiLebar" aria-describedby="kubikasiLebarText" placeholder="isi lebar">
                                </td> 
                                <td>
                                    <input type="text" class="form-control fs-6" name="kubikasiTinggi[]" value="<?php echo old('kubikasiTinggi')[$i]; ?>" id="kubikasiTinggi" aria-describedby="kubikasiTinggiText" placeholder="isi tinggi">
                                </td> 
                                <td>
                                    <input type="text" class="form-control fs-6" name="berat[]" value="<?php echo old('berat')[$i]; ?>" id="kubikasiBerat" aria-describedby="kubikasiBeratText" placeholder="isi berat">
                                </td>  
                            <?php else: ?> 
                                <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\backup\resources\views/page/admin/CargoPengirimanTruk.blade.php ENDPATH**/ ?>