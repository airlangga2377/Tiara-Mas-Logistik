            ...
            <div class="col-xl-8 col-md-0 col-sm-0 shadow-sm p-3" id="tableIdParent"> 
                ...
                <table id="tableId" class="display">
                    ...
                    <?php $__currentLoopData = $allCargo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                        <?php if($barang->no_manifest && !($barang->jenis_pengiriman != $jenisUser && !Auth::user()->is_user_superadmin)): ?> 
                            <tr>
                                <td data-toggle="tooltip" data-placement="top" title="Jenis Pengiriman <?php echo e($barang->jenis_pengiriman); ?>"><?php echo e($index); ?></td> 
                                <?php
                                    $index++
                                ?>
                                ...
                                <?php if($barang->jenis_pengiriman == "truk" || $name == "superadmin"): ?>
                                    <td>
                                        <div class="row justify-content-start align-items-center g-2 px-3">
                                            <?php if($barang->last_id_message_tracking == 1  && ($barang->asal == $kodeKota->id_kode_kota || $name == "superadmin")): ?> 
                                            ...
                                            <?php if(($barang->last_id_message_tracking == 2) && ($barang->tujuan == $kodeKota->id_kode_kota || $name == "superadmin")): ?> 
                                                <div class="col-6 text-center">
                                ...
                                <?php if($barang->jenis_pengiriman == "bus" || $name == "superadmin"): ?>
                                    <td>
                                        <div class="row justify-content-start align-items-center g-2 px-3">
                                            <?php if($barang->last_id_message_tracking == 1  && ($barang->asal == $kodeKota->id_kode_kota || $name == "superadmin")): ?> 
                                            <div class="col-6 text-center">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\agi\Desktop\kerja\Kargo Website\resources\views/page/admin/manifest/CargoPengirimanManifest.blade.php ENDPATH**/ ?>