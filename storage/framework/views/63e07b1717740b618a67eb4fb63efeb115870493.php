                        ...
                        <div class="col-12"> 
                            ...
                            <div class="mb-xl-3 mb-sm-5 p-3 w-60"> 
                                ...
                                <select class="form-select" aria-label="Pilih asal" id="selectBoxAsal" data-live-search="true" name="asal">
                                    <option disabled <?php if(old("asal") == null || old() == null): ?> selected <?php endif; ?> value>Silahkan Pilih Asal</option>
                            ...
                            <div class="mb-xl-3 mb-sm-5 p-3 w-60"> 
                                ...
                                <select class="form-select" aria-label="Pilih tujuan" id="selectBoxTujuan" data-live-search="true" name="tujuan">
                                    <option disabled <?php if(old("tujuan") == null || old() == null): ?> selected <?php endif; ?> value>Silahkan Pilih Tujuan</option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\agi\Desktop\kerja\Kargo Website\resources\views/page/admin/Truk/CargoPengirimanTruk.blade.php ENDPATH**/ ?>