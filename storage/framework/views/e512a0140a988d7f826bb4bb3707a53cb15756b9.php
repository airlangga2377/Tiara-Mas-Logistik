            ...
            <div class="col">
                <table style="border-top-style: hidden;" class="table-jumlahbarang">
                    ...
                    <tbody style="border-bottom-style: hidden;border-left-style: hidden;">
                        <tr>
                            <td>
                                <?php echo e($data->jumlah_barang); ?> Koli
                            </td>
                            <td>
                                <?php echo e($data->berat); ?> Kg
                            </td>
                            <td style="font-size: 30px;">
                                Rp. <?php echo e(number_format($data->biaya)); ?>
            ...
            <div class="col">
                <table class="table-jenisbarang">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <?php echo e($data->jenis_barang); ?>

                            </td>
                            <td>
                                <?php echo e($data->jenis_paket); ?>
                ...
                <table class="table-ttd">
                    <thead>
                        <tr>
                            ...
                            <th style="padding-bottom: 100px;padding-top: 30px;">
                                <?php echo e(ucfirst($detail->user->kota)); ?>, <?php echo e($detail->created); ?>
...
</html><?php /**PATH C:\Users\agi\Desktop\kerja\Kargo Website\resources\views/page/admin/Bus/resi/CetakResi.blade.php ENDPATH**/ ?>