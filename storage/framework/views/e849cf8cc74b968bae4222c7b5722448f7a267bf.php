                    ...
                    <div class="col"> 
                        ...
                        <select class="form-select" aria-label="Pilih tujuan" id="selectBoxTujuan" data-live-search="true" name="tujuan">
                            ...
                            <?php $__currentLoopData = $allWilayah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wilayah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($kodeKota->wilayah != $wilayah->wilayah || $isUserSuperadmin): ?> <option value="<?php echo e($wilayah->id_kode_kota); ?>" <?php if(old("id_kode_kota_asal") == $wilayah->wilayah): ?> selected <?php endif; ?>><?php echo e(ucfirst($wilayah->kota)); ?></option> <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\agi\Desktop\kerja\Kargo Website\resources\views/page/admin/manifest/CargoPengirimanManifestInput.blade.php ENDPATH**/ ?>