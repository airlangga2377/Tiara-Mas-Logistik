                                ...
                                <div class="mb-xl-3 mb-sm-5">                             
                                    ...
                                    <select type="option" id="pickup" class="form-control select-pickup shadow-sm p-3" name="asal" id="pickup" aria-describedby="pickupText" value="<?php echo old('pickup'); ?>">
                                        ...
                                        <?php $__currentLoopData = $allWilayah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wilayah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($kodeKota->wilayah != $wilayah->wilayah || $isUserSuperadmin): ?> <option value="<?php echo e($wilayah->id_kode_kota); ?>" <?php if(old("id_kode_kota_asal") == $wilayah->wilayah): ?> selected <?php endif; ?>><?php echo e($wilayah->wilayah); ?></option> <?php endif; ?>
                        ...
                        <div class="col">
                            <div class="mb-xl-3 mb-sm-5">
                                ...
                                <select type="option" id="dropoff" class="form-control" name="tujuan" id="tujuanBarang" aria-describedby="tujuanBarangText" value="<?php echo old('tujuanBarang'); ?>">
                                    ...
                                    <?php $__currentLoopData = $allWilayah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wilayah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($kodeKota->wilayah != $wilayah->wilayah || $isUserSuperadmin): ?> <option value="<?php echo e($wilayah->id_kode_kota); ?>" <?php if(old("id_kode_kota_tujuan") == $wilayah->wilayah): ?> selected <?php endif; ?>><?php echo e($wilayah->wilayah); ?></option> <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\agi\Desktop\kerja\Kargo Website\resources\views/page/admin/Bus/CargoPengirimanBus.blade.php ENDPATH**/ ?>