                ...
                <div class="collapse" id="collapseKubikasi">
                    <div class="card card-body"> 
                        <div class="mb-xl-3 mb-sm-5">
                            ...
                            <input type="text" class="form-control shadow-sm <?php if($errors->any()): ?> is-invalid <?php endif; ?>" name="kubikasiBerat" id="kubikasiBerat" aria-describedby="kubikasiBeratText" placeholder="isi berat">
                            <div id="validationkubikasiBerat" class="invalid-feedback">
                                <?php if(Session::has('kubikasiBeratError')): ?> <?php endif; ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Kargo Website\resources\views/page/admin/CargoPengirimanBarang.blade.php ENDPATH**/ ?>