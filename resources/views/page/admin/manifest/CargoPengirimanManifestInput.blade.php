                    ...
                    <div class="col"> 
                        ...
                        <select class="form-select" aria-label="Pilih tujuan" id="selectBoxTujuan" data-live-search="true" name="tujuan">
                            ...
                            @foreach ($allWilayah as $wilayah)
                                @if ($kodeKota->wilayah != $wilayah->wilayah || $isUserSuperadmin) <option value="{{ $wilayah->id_kode_kota }}" @if (old("id_kode_kota_asal") == $wilayah->wilayah) selected @endif>{{ ucfirst($wilayah->kota) }}</option> @endif
                            @endforeach
                        </select>
                    </div>   
                </div> 
